...
public class CaseCount implements Serializable
{
    ...
    public CaseCount(String courtTable, int count[])
    {
    ...
    public int getMaxYear(int[] count)
    {
        int max = 2010;
    ...
    public void addSelectedNumber(String selectedNumber) {
        selectedNumbers.add(selectedNumber);
        Log.d("CaseLog", "CaseCount.addSelectedNumber():  " +selectedNumber);
    }
